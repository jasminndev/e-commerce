...
urlpatterns = [
    ...
    path('login/login_w_passwd', LoginWithPasswordFormView.as_view(), name="login_with_password"),
    ...
    path('account/profile/change-passwd/<int:pk>', ChangePasswordFormView.as_view(), name='change_password'),
